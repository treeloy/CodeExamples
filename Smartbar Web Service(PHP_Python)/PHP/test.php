...
<div id="footer">
	...
	<div class="four columns">
		<h1>ABOUT US</h1>
		 Solutions for your autonomous drinking needs.
	</div>
	<div class="four columns">
		<h1>GET SOCIAL</h1>
		<div class="social facebook">
			<a href="http://www.facebook.com/pages/UCSC-SmartBar/819870698091414"></a>
		</div>
	...
	<div class="four columns">
		<h1 class="newsmargin">Download our App</h1>
		<div class="row collapse newsletter floatright">
			<div class="ten mobile-three columns">
				<input type="text" class="nomargin" placeholder="Enter your mobile number...">
			</div>
			<div class="two mobile-one columns">
				<a href="#" class="postfix button expand">GO</a>
			</div>
...
<div class="copyright">
	<div class="row">
		<div class="six columns">
			 &copy;<span class="small"> Copyright 2015 UCSC</span>
		</div>
		<div class="six columns">
			<span class="small floatright"> UCSC SmartBar Team</span>
		</div>
	</div>
</div>
  <!-- JAVASCRIPTS 
